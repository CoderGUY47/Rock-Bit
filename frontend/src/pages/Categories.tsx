        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {CRYPTO_CATEGORIES.map((cat, idx) => (
            <Link
              key={idx}
              href="/markets"
              className="bg-white dark:bg-[#23262f] p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-xl transition-all duration-300 group hover:-translate-y-1"
            >
