...
export const EasyTrading = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-[#0c0c0e] transition-colors duration-300 overflow-hidden border-t border-gray-100 dark:border-gray-900">
      <div className="w-[70%] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          {/* Left Column: Beautiful Overlapping Chart & QR Code Illustration */}
          <div className="lg:col-span-7 relative flex justify-center items-center py-10">
            {/* The Main Chart Card */}
            <div className="relative w-full max-w-[560px] bg-white dark:bg-white/[0.04] dark:backdrop-blur-md border border-gray-100 dark:border-white/[0.08] rounded-3xl p-6 shadow-xl shadow-gray-200/40 dark:shadow-black/40 z-10 transition-all duration-300">
              {/* Card Header */}
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-base font-extrabold text-gray-950 dark:text-white tracking-tight">
                      BTCUSDT
                    </h4>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  {["1m", "1h", "1d"].map((tab) => (
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-black uppercase tracking-wider rounded-lg transition-colors cursor-pointer ${
                        activeTab === tab
            ...
            <div className="absolute -right-6 top-[90px] w-[210px] bg-white dark:bg-white/[0.04] dark:backdrop-blur-md p-3 rounded-xl shadow-xl shadow-gray-200/40 dark:shadow-black/40 border border-gray-100 dark:border-white/[0.08] z-20 flex items-center gap-3 transition-transform duration-300 hover:scale-105 select-none">
              ...
              <div className="space-y-0.5">
                <div className="flex items-baseline gap-1 text-[11px] font-black text-gray-900 dark:text-white">
                  <span>+12 BTC</span>
                </div>
                <div className="text-[9px] text-secondary dark:text-secondary2 font-bold">
                  Esther Howard
                </div>
              </div>
            </div>
            ...
            <div className="absolute -right-2 bottom-[90px] w-[210px] bg-white dark:bg-white/[0.04] dark:backdrop-blur-md p-3 rounded-xl shadow-xl shadow-gray-200/40 dark:shadow-black/40 border border-gray-100 dark:border-white/[0.08] z-20 flex items-center gap-3 transition-transform duration-300 hover:scale-105 select-none">
              <div className="w-10 h-10 rounded-full overflow-hidden shrink-0 bg-primary/10 flex items-center justify-center font-bold text-xs text-primary">
                JW
              </div>
              <div className="space-y-0.5">
                <div className="flex items-baseline gap-1 text-[11px] font-black text-gray-900 dark:text-white">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="space-y-8">
              {/* Step 1: Download */}
              <div className="flex items-center gap-3 group bg-gray-100 rounded-2xl p-3 dark:bg-white/5">
                  <Image
                ...
                <div className="space-y-0">
                  <span className="text-[10px] text-primary dark:text-indigo-400 font-bold uppercase">
                    Step 1
                  </span>
