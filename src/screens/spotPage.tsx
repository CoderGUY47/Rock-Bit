...
export default function SpotPage() {
  ...
  // Toast Notification handler using custom Glassmorphism Toasts
  ...
  // Sync Favorites to LocalStorage with custom Toasts
  ...
  useEffect(() => {
    ...
    const fetchLivePrices = async () => {
      try {
        ...
        console.error('Failed to fetch live prices in spot', e);
      }
    };
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#0c0c0e] min-h-screen text-gray-800 dark:text-gray-200 antialiased font-sans">
      <Head>
        <title>{activeSymbol}/USDT | Rock-Bit Spot</title>
