    ...
    <div className="bg-[#f8f9fa] dark:bg-[#0c0c0e] min-h-screen py-16 transition-colors duration-200">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white mt-4 mb-3">
            Contact Support
          </h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
            Have questions about your portfolio, trades, or custom token
            listings? Reach out to our team.
          </p>
        </div>
            ...
            {success ? (
              <div className="text-center py-10 space-y-3">
                ...
                <p className="text-xs text-gray-400">
                  Our customer operations department will get back to you
                  shortly.
                </p>
                <button
