...
export default function ItemDetailsPage() {
  ...
  const relatedItems = allItems
    .filter(
      (i) =>
        i.id !== item.id &&
        (i.category === item.category || i.category === "L1"),
    )
    .slice(0, 3);
  ...
  return (
    <div className="bg-[#f8f9fa] dark:bg-[#0c0c0e] min-h-screen py-10 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Link
          href="/markets"
          className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-primary transition-colors mb-8 cursor-pointer"
        >
          ...
          <div className="lg:col-span-5 flex flex-col justify-between bg-white dark:bg-[#141416]/90 border border-gray-100 dark:border-white/[0.06] rounded-3xl p-8 shadow-sm">
            <div>
              ...
              <div className="flex items-center justify-between gap-3 mb-4">
                <span className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-[10px] font-bold uppercase px-3 py-1 rounded-full tracking-wider">
                  {item.category}
                </span>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-50 dark:border-gray-800">
                  ...
                  <span
                    className={`text-sm font-bold flex items-center gap-0.5 ${item.change24h >= 0 ? "text-green-500" : "text-red-500"}`}
                  >
                    {item.change24h >= 0 ? "+" : ""}
                    {item.change24h}%
                  </span>
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-gray-800">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider">
                    7-Day Price Trend (USD)
                  </h3>
                  <span className="text-[10px] bg-green-500/10 text-green-500 font-bold px-2.5 py-1 rounded-full uppercase tracking-widest">
                    Live Chart
                  </span>
                </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between py-2">
                    ...
                    <span className="text-xs font-bold text-gray-900 dark:text-white">
                      {item.isCustom ? "User Created" : "Verified Native"}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                {reviews.map((review) => (
                  <div
                    key={review.id}
                    className="p-5 rounded-2xl bg-gray-50 dark:bg-[#1d1d22] border border-gray-100 dark:border-gray-800/40"
                  >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedItems.map((relItem) => (
                <div
                  key={relItem.id}
                  className="bg-white dark:bg-[#141416]/90 border border-gray-100 dark:border-white/[0.06] rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col h-[380px]"
                >
                  <div className="h-40 bg-gray-50 overflow-hidden relative shrink-0">
                    <img
                      ...
                      className="w-full h-full object-cover"
                    />
                    <span className="absolute top-4 left-4 bg-gray-900/80 backdrop-blur-md text-white text-[9px] font-bold uppercase px-2 py-0.5 rounded-full">
                      {relItem.category}
                    </span>
                  </div>
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-sm truncate mb-1">
                        {relItem.title}
                      </h4>
