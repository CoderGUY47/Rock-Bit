      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-10">
          <div className="text-center sm:text-left">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white flex items-center gap-2 justify-center sm:justify-start">
              <FiSettings className="text-primary w-6 h-6" />
              Manage Custom Assets
            </h1>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
              Manage, view, and delete custom listings created in your session.
            </p>
          </div>
          <Link
            href="/items/add"
          ...
          {items.length === 0 ? (
            <div className="p-12 text-center">
              <p className="text-gray-400 dark:text-gray-500 font-medium mb-4">
                You have not created any custom assets yet.
              </p>
              <Link
                href="/items/add"
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-gray-100 dark:border-gray-800 text-[10px] font-bold uppercase text-gray-400 tracking-wider">
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-gray-800/40 text-xs font-semibold">
                  {items.map((item) => (
                    <tr
                      key={item.id}
                      className="hover:bg-gray-50/50 dark:hover:bg-[#1d1d22]/30 transition-colors"
                    >
                      <td className="px-6 py-4 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-gray-400 font-medium block truncate max-w-[200px]">
                            {item.shortDesc}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-[9px] font-bold uppercase px-2 py-0.5 rounded-full">
                          {item.category}
                        </span>
                      </td>
