...
export const Banner = () => {
  return (
    <section className="relative w-full bg-white dark:bg-[#0c0c0e] py-2 lg:py-4 overflow-hidden select-none border-none dark:border-white/[0.03] z-2">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden">
        <Image
          ...
          alt=""
          fill
          className="object-contain opacity-[0.8] dark:opacity-[0.15]"
          unoptimized
        />
      </div>
          ...
          <div className="lg:col-span-6 space-y-2 text-left">
            <div className="space-y-6">
              ...
              <p className="text-sm md:text-base text-secondary dark:text-gray-400 font-medium max-w-lg leading-relaxed">
                Rock-Bit is the easiest, safest, and fastest way to buy &amp;
                sell crypto assets.
              </p>
            </div>
            ...
            <div className="mt-10 mb-4">
              <span className="text-base uppercase font-bold tracking-widest text-gray-400">
                Our Partners
              </span>
              <div className="flex flex-wrap items-center opacity-60 dark:opacity-50">
                <Image
